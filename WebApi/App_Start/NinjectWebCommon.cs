...
namespace WebApi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            kernel.Bind<IInspirationalQuoteRepository>().To<InspirationalQuoteRepository>();
            kernel.Bind<IPersonalSiteIdentityService>().To<PersonalSiteIdentityService>();
            kernel.Bind<PersonalSiteContext>().To<PersonalSiteContext>();
        }        
    }
}
